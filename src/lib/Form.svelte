<script lang="ts">
    import { Form, FormGroup, FormText, Input, Label, CheckBox, CheckBoxItem } from '@statsforvalteren/staf-komponentbibliotek-svelte';
  import type { InputProps } from '@statsforvalteren/staf-komponentbibliotek-svelte/src/Input';
    let radioGroup: InputProps;
  </script>
